...
const Hero: React.FC<HeroProps> = ({ profileImage }) => {
  ...
  return (
    <section id = "hero" className="relative w-full h-screen flex flex-col items-center justify-center text-center px-6 sm:px-12 overflow-hidden">
      {/* Partículas vienen de App.tsx */}
      ...
      >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-tr from-cyan-600/30 to-purple-600/30 group-hover:opacity-0 transition-opacity duration-700 z-10" />
          <img
            src={profileImage}
            alt="Foto de perfil"
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-70 group-hover:opacity-0 transition-opacity duration-700" />
        </motion.div>
        ...
        <motion.h1
          ...
          style={{ backgroundSize: '300% 100%', animation: 'animateGradient 6s ease infinite' }}
        ...
        >
          ...
          <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-24 h-0.5 bg-gradient-to-r from-transparent via-cyan-400/50 to-transparent" />
        </motion.div>
        ...
        >
          Transformo ideas en experiencias digitales impactantes mediante código limpio, diseño funcional y un enfoque{' '}
          <span className="text-cyan-300">100% creativo</span>.
        </motion.p>
        ...
        >
          ...
          <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-cyan-400 to-blue-500 group-hover:to-purple-600 transition-all duration-300 opacity-0 group-hover:opacity-100" />
          <span className="absolute -inset-4 w-[calc(100%+2rem)] h-[calc(100%+2rem)] rounded-full bg-cyan-400/20 blur-xl opacity-0 group-hover:opacity-70 transition-opacity duration-300 group-hover:animate-pulse-fast" />
        </motion.button>
      </motion.div>
    </section>
  );
